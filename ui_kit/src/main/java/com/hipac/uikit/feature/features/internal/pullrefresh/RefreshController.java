package com.hipac.uikit.feature.features.internal.pullrefresh;
...
import com.hipac.uikit.feature.features.DragToRefreshFeature;
import com.hipac.uikit.feature.features.PullToRefreshFeature;
import com.hipac.uikit.utils.Config;
...
public class RefreshController {
        ...
        if (mIsRefreshable && !mIsScrolling) {
            switch (event.getAction() & MotionEventCompat.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mIsMultiPointer) { //如果已经发生了多点触控
    ...
    public void setOnRefreshListener(PullToRefreshFeature.OnPullToRefreshListener refreshListener) {
        this.mPullRefreshListener = refreshListener;
        mIsRefreshable = true;
    }

    public void setOnRefreshListener(DragToRefreshFeature.OnDragToRefreshListener refreshListener) {
