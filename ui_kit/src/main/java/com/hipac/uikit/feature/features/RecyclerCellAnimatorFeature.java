...
import com.hipac.uikit.feature.callback.RecyclerAdapterCallback;
import com.hipac.uikit.feature.features.cellanimator.RecyclerCellAnimatorAdapter;
import com.hipac.uikit.feature.features.cellanimator.RecyclerCellAnimatorController;
...
public class RecyclerCellAnimatorFeature extends AbsFeature<RecyclerView> implements RecyclerAdapterCallback {
    ...
    @Override
    public void beforeSetAdapter(Adapter adapter) {
    }

    @Override
    public void afterSetAdapter(Adapter adapter) {
