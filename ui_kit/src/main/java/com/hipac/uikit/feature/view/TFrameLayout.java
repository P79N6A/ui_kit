...
public class TFrameLayout extends FrameLayout implements ViewHelper, ViewGroupHelper, IFeatureList<FrameLayout> {
    ...
    private FeatureList<FrameLayout> mFeatureList = new FeatureList<FrameLayout>(this);
    ...
    @Override
    public boolean addFeature(AbsFeature<? super FrameLayout> feature) {
        return mFeatureList.addFeature(feature);
    }

    @Override
    public AbsFeature<? super FrameLayout> findFeature(
            Class<? extends AbsFeature<? super FrameLayout>> clazz) {
        return mFeatureList.findFeature(clazz);
    }

    @Override
    public boolean removeFeature(Class<? extends AbsFeature<? super FrameLayout>> clazz) {
