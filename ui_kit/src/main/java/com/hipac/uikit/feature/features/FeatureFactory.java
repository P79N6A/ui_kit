...
public class FeatureFactory {
    ...
    private static final int PRIORITY_HIGHEST = 1000;
    private static final int PRIORITY_ABOVE_NORMAL = 750;
    private static final int PRIORITY_NORMAL = 500;
    private static final int PRIORITY_BELOW_NORMAL = 250;
    ...
    private static class AttachInfo {
        ...
        AttachInfo(int id, int priority) {
            this.id = id;
    ...
    static {
        ...
        featureMap.put("RatioFeature", new AttachInfo(
        ...
        featureMap.put("RoundRectFeature", new AttachInfo(
                ...
                PRIORITY_NORMAL));
        featureMap.put("RoundFeature", new AttachInfo(
        ...
        featureMap.put("CellAnimatorFeature", new AttachInfo(
                ...
                PRIORITY_NORMAL));
        featureMap.put("RecyclerCellAnimatorFeature", new AttachInfo(
                R.styleable.FeatureNameSpace_uik_recyclerCellAnimatorFeature,
                PRIORITY_NORMAL));
    ...
    public static <T extends View> ArrayList<AbsFeature<? super T>> creator(
        ...
        ArrayList<AbsFeature<? super T>> features = new ArrayList<>();
